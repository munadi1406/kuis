...
import { l as levels, g as getEventPrefix, e as ensure404Route, d as default404Instance, D as DEFAULT_404_ROUTE, L as Logger, A as AstroIntegrationLogger, m as manifest } from './chunks/_@astrojs-manifest_B0Rz1ydo.mjs';
...
const _page1 = () => import('./pages/api/auth/detail.astro.mjs');
...
const _page5 = () => import('./pages/api/image.astro.mjs');
const _page6 = () => import('./pages/api/kelas/all.astro.mjs');
const _page7 = () => import('./pages/api/kelas.astro.mjs');
const _page8 = () => import('./pages/api/mapel/all.astro.mjs');
const _page9 = () => import('./pages/api/mapel.astro.mjs');
const _page10 = () => import('./pages/api/quiz.astro.mjs');
const _page11 = () => import('./pages/api/user/data.astro.mjs');
const _page12 = () => import('./pages/api/user/password-ad.astro.mjs');
const _page13 = () => import('./pages/api/user/role.astro.mjs');
const _page14 = () => import('./pages/api/user/user-role.astro.mjs');
const _page15 = () => import('./pages/createkuis.astro.mjs');
const _page16 = () => import('./pages/dashboard.astro.mjs');
const _page17 = () => import('./pages/detailusers.astro.mjs');
const _page18 = () => import('./pages/feedback.astro.mjs');
const _page19 = () => import('./pages/history.astro.mjs');
const _page20 = () => import('./pages/kelas.astro.mjs');
const _page21 = () => import('./pages/kuis/_kuis_.astro.mjs');
const _page22 = () => import('./pages/log.astro.mjs');
const _page23 = () => import('./pages/mapel.astro.mjs');
const _page24 = () => import('./pages/profile.astro.mjs');
const _page25 = () => import('./pages/register.astro.mjs');
const _page26 = () => import('./pages/users.astro.mjs');
const _page27 = () => import('./pages/index.astro.mjs');

const pageMap = new Map([
    ["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
    ["src/pages/api/auth/detail.js", _page1],
    ["src/pages/api/auth/register.js", _page2],
    ["src/pages/api/auth/signin.js", _page3],
    ["src/pages/api/auth/signout.js", _page4],
    ["src/pages/api/image/index.js", _page5],
    ["src/pages/api/kelas/all.js", _page6],
    ["src/pages/api/kelas/index.js", _page7],
    ["src/pages/api/mapel/all.js", _page8],
    ["src/pages/api/mapel/index.js", _page9],
    ["src/pages/api/quiz/index.js", _page10],
    ["src/pages/api/user/data.js", _page11],
    ["src/pages/api/user/password-ad.js", _page12],
    ["src/pages/api/user/role.js", _page13],
    ["src/pages/api/user/user-role.js", _page14],
    ["src/pages/createKuis.astro", _page15],
    ["src/pages/dashboard.astro", _page16],
    ["src/pages/detailUsers.astro", _page17],
    ["src/pages/feedback.astro", _page18],
    ["src/pages/history.astro", _page19],
    ["src/pages/kelas.astro", _page20],
    ["src/pages/kuis/[kuis].astro", _page21],
    ["src/pages/log.astro", _page22],
    ["src/pages/mapel.astro", _page23],
    ["src/pages/profile.astro", _page24],
    ["src/pages/register.astro", _page25],
    ["src/pages/users.astro", _page26],
...
const _args = {
    "middlewareSecret": "8cc606a2-c159-4a7f-94a4-447a9da361af",
