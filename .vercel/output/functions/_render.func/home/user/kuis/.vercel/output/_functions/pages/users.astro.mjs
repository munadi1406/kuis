...
import 'kleur/colors';
import { W as WithQuery, t as toast, L as Label, I as Input, D as Dialog, h as DialogTrigger, B as Button, a as DialogContent, d as DialogHeader, e as DialogTitle, g as DialogFooter, S as Select, i as SelectTrigger, j as SelectValue, k as SelectContent, l as SelectItem, $ as $$Dashboard } from '../chunks/Dashboard_BZnJtW5m.mjs';
...
import { g as generatePdf } from '../chunks/generatePdf_DQYPVC_-.mjs';
import { C as CardUser } from '../chunks/CardUser_Dt74LfI4.mjs';
export { renderers } from '../renderers.mjs';

const ChangePassword = lazy(() => import('../chunks/ChangePassword_Ceqok2eR.mjs'));
const UsersData = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "border rounded-md", children: [
    ...
    /* @__PURE__ */ jsxs(Table, { children: [
      ...
      /* @__PURE__ */ jsx(TableBody, { children: userData && userData.map(
        ({ email, username, role, id_user }, i) => /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { className: "font-medium", children: /* @__PURE__ */ jsxs(
            Select,
            {
              onValueChange: (e) => roleChange.mutate({ role: e, id: id_user }),
              disabled: roleChange.isPending,
              children: [
                /* @__PURE__ */ jsx(SelectTrigger, { className: "w-[180px]", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: role }) }),
                /* @__PURE__ */ jsxs(SelectContent, { children: [
                  /* @__PURE__ */ jsx(SelectItem, { value: "admin", children: "Admin" }),
                  /* @__PURE__ */ jsx(SelectItem, { value: "users", children: "Users" })
                ] })
              ]
            }
          ) }),
